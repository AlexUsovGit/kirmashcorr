...
public class ProductController {
  ...
  public String producttableFilter(@RequestParam String myfilter, @RequestParam String author,
  ...
  public String productadd(Map<String, Object> model) {
    ...
    if (!compositions.iterator().hasNext()) {
      compos.add(new Composition("test", "test", "true"));
    } else {
      compositions.iterator().forEachRemaining(compos::add);
    }
    model.put("compositions", compos);
  ...
  public String setDistrib(@RequestParam String id, @RequestParam String myfilter, Map<String, Object> model)
      throws IOException {
    List<Product> products = new ArrayList<>();
  ...
  public String delDistrib(@RequestParam String id, @RequestParam String myfilter, Map<String, Object> model)
      throws IOException {
    List<Product> products = new ArrayList<>();
